...
class Main extends PluginBase implements Listener {
	...
	public function onBlockPlaceEvent(BlockPlaceEvent $ev) {
		...
		$ev->getPlayer()->sendMessage("[Dreambuild-Enderchests] Enderkiste gesetzt!");
	}
	...
	public function onInventoryCloseEvent(InventoryCloseEvent $ev) {
		...
		if ($this->unlockChest($player,$inv)) {
			$player->sendMessage("[Dreambuild-Enderchests] Enderkiste geschlossen!");
	...
	public function onInventoryOpenEvent(InventoryOpenEvent $ev) {
		...
		if (!$this->lockChest($player,$inv)) {
			$player->sendTip("[Dreambuild-Enderchests] Diese Kiste wird gerade benutzt!");
			$ev->setCancelled();
			return;
		}
		$player->sendMessage("[Dreambuild-Enderchests] Enderkiste aufgemacht!");
